...
def _extract_argmax_and_embed(embedding,
    ...
    def loop_function(prev, prev_probs, beam_size, _):  # prev_probs, beam_size are added by shiyue
        ...
        # prev_symbol = math_ops.argmax(prev, 1) #annotated by shiyue
        # added by shiyue
...
def embedding_attention_decoder(encoder_mask_1, encoder_mask_2, decoder_inputs, initial_state, 
    ...
    with variable_scope.variable_scope(scope or "embedding_attention_decoder"):
        ...
        return attention_decoder(encoder_mask_1, encoder_mask_2,
                                 emb_inp, initial_state, 
                                 attention_states_1, attention_states_2, cell,
                                 beam_size,  # added by shiyue
...
def model_with_buckets(encoder_inputs, encoder_mask, decoder_inputs, targets, weights,
    ...
    return outputs, losses, symbols  # modified by shiyue
