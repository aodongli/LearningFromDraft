...
tf.app.flags.DEFINE_integer("en_vocab_size", 25000, "Pre-trained English vocabulary size.")
tf.app.flags.DEFINE_integer("fr_vocab_size", 10000, "English vocabulary size.")
tf.app.flags.DEFINE_string("data_dir", "../data_iwslt_t", "Data directory")
tf.app.flags.DEFINE_string("train_dir", "../train_iwslt_t", "Training directory.")
...
_buckets = [(15, 10), (25, 15), (45, 25), (65, 35)] # added by al
